...
{
        return [[self class] hx_propertyKeys];
}
+ (NSArray *)hx_propertyKeys {
...
{
        return [[self class] hx_propertiesInfo];
}
/**
...
+ (NSArray *)hx_propertiesInfo
{
        ...
        for (int i = 0; i < propertyCount; i++)
        {
                [propertieArray addObject:({
                        ...
                        NSDictionary *dictionary = [self hx_dictionaryWithProperty:properties[i]];
...
+ (NSArray *)hx_propertiesWithCodeFormat
{
        ...
        NSArray *properties = [[self class] hx_propertiesInfo];
...
-(NSArray*)hx_methodListInfo{
        ...
        for (int i = 0; i < count ; i++)
        {
                ...
                for (int index=0; index<argumentsCount; index++) {
                        ...
                        [arguments addObject:[[self class] hx_decodeType:arg]];
                }
                
                NSString *returnTypeString =[[self class] hx_decodeType:returnType];
                NSString *encodeString = [[self class] hx_decodeType:encoding];
...
-(NSDictionary *)hx_protocolList{
        return [[self class]hx_protocolList];
}
+ (NSDictionary *)hx_protocolList
{
...
+ (NSArray *)hx_instanceVariable
{
        ...
        NSMutableArray *result = [NSMutableArray array];
        for (int i = 0; i < outCount; i++) {
                NSString *type = [[self class] hx_decodeType:ivar_getTypeEncoding(ivars[i])];
...
#pragma mark -- help
+ (NSDictionary *)hx_dictionaryWithProperty:(objc_property_t)property
{
...
+ (NSString *)hx_decodeType:(const char *)cString
{
        ...
        } else
        {
                if ([[result substringToIndex:1] isEqualToString:@"^"]) {
                        result = [NSString stringWithFormat:@"%@ *",
                                  [NSString hx_decodeType:[[result substringFromIndex:1] cStringUsingEncoding:NSUTF8StringEncoding]]];
                }
        }
        return result;
}
