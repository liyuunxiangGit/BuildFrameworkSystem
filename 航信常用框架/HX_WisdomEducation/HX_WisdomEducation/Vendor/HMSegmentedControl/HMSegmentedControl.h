...
typedef NS_ENUM(NSInteger, HMSegmentedControlDotType) {
    HMSegmentedControlDotTypeLeft,
    HMSegmentedControlDotTypeRight,
};

@interface HMSegmentedControl : UIControl

@property (nonatomic, strong) NSArray *sectionNumbers;
...
/**
 item position, default is HMSegmentedControlTypeLeft
 */
@property (nonatomic, assign) HMSegmentedControlDotType dotType;

/**
 item reminder count size， default is (2.5, 2.5,2.5,2.5)
 */
@property (nonatomic, assign) UIEdgeInsets dotContentInset;

/**
 item reminder offset, default is (0, 0)
 */
@property (nonatomic, assign) CGPoint dotOffset;

/**
 item background color, default is red color
 */
@property (nonatomic, strong) UIColor *dotBgColor;

/**
 reminder text color, default is white color
 */
@property (nonatomic, strong) UIColor *dotTextColor;

/**
 reminder text Font, default is 10 font value
 */
@property (nonatomic, assign) CGFloat dotFont;
