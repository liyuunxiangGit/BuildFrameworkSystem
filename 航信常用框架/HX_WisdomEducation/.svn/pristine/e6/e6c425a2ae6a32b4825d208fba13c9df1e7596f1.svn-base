...
+(NSString *)customTimeString:(NSString *)string{
    //    时间戳
...
+(NSString *)customTwoTimeString:(NSString *)string{
    //    时间戳
    NSTimeInterval interval    =[string doubleValue] / 1000.0;
    NSDate *date               = [NSDate dateWithTimeIntervalSince1970:interval];
...
+(NSString *)customThrTimeString:(NSString *)string{
    //    时间戳
    NSTimeInterval interval    =[string doubleValue] / 1000.0;
    NSDate *date               = [NSDate dateWithTimeIntervalSince1970:interval];
...
+(NSString *)customfourTimeString:(NSString *)string{
    //    时间戳
    NSTimeInterval interval    =[string doubleValue] / 1000.0;
    NSDate *date               = [NSDate dateWithTimeIntervalSince1970:interval];
